...
[![Latest Version on Packagist](https://img.shields.io/badge/packagist-v2.0-blue)](https://packagist.org/packages/moe-mizrak/laravel-prompt-alchemist)
<br />
...
- [🎨 Usage](#-usage)
    - [Using Facade](#using-facade)
        ...
        - [Define Function Signature Mapping](#define-function-signature-mapping)
        - [Generate Prompt Function Instructions](#generate-prompt-function-instructions)
